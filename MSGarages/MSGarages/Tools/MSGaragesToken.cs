...
namespace MSGarages.Tools
{
    public class MSGaragesToken
    {
        ...
        public MSGaragesToken(IConfiguration configuration)
        {
        ...
        public string GetUserIdRoleToken(string token)
        {
            ...
            if (token == null)
                throw new MSGaragesException(ExceptionsDetails.INVALID_TOKEN);
            ...
            try
            {
                ...
                if (userId == 0)
                    throw new MSGaragesException(ExceptionsDetails.INVALID_USER_ID_FROM_TOKEN);

                if (userRole == null)
                    throw new MSGaragesException(ExceptionsDetails.INVALID_USER_ROLE_FROM_TOKEN);
