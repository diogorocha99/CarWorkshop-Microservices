namespace MSGarages.Exceptions
{
    public class ExceptionsDetails
    {
        ...
        public static string GARAGE_ALREADY_EXISTS
        {

            get { return "Garage Already Exists!"; }
        ...
        public static string INVALID_LICENSEPLATE
        {

            get { return "Invalid License Plate! "; }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_ADDING_NEW_VEHICLE
        {

            get { return "Something Went Wrong While Adding a New Vehicle!"; }

        }


        public static string LICENSE_PLATE_ALREADY_EXISTS
        {

            get { return "This License Plate Already Exists!"; }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_CREATING_GARAGE
        {

            get { return "Something Went Wrong While creating garage!"; }
        ...
        public static string SOMETHING_WENT_WRONG_WHILE_ADDING_EMPLOYEE
        {

            get { return "Something Went Wrong While adding employee!"; }

        }

        public static string USER_IS_NOT_A_EMPLOYEE
        {
            get { return "User is not a employee! You need to add permissions"; }
        }



        public static string EMPLOYEE_ALREADY_WORKING
        {
            get { return "Employee has previously been added to another garage"; }
        }

        public static string GARAGE_DOES_NOT_EXIST
        {
            get { return "Garage does not exist, please insert a valid one"; }
        }


        public static string EMPLOYEE_NOT_WORKING
        {
            get { return "Employee is not working"; }
        }
