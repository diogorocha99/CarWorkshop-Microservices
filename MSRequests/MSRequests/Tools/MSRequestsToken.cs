...
#region MSRequests Class

namespace MSRequests.Tools
{

    public class MSRequestsToken
    {
        ...
        public MSRequestsToken(IConfiguration configuration)
        {
        ...
        public string GetUserIdRoleToken(string token)
        {
            ...
            if (token == null)
                throw new MSRequestsException(ExceptionsDetails.INVALID_TOKEN);
            ...
            try
            {
                ...
                if (userId == 0)
                    throw new MSRequestsException(ExceptionsDetails.INVALID_USER_ID_FROM_TOKEN);

                if (userRole == null)
                    throw new MSRequestsException(ExceptionsDetails.INVALID_USER_ROLE_FROM_TOKEN);
