...
namespace MSRepairs.Exceptions
{
    ...
    public class ExceptionsDetails
    {
        ...
        public static string SOMETHING_WENT_WRONG_WHILE_CREATING_REPARATION
        {

            get { return "Something Went Wrong While Creating Reparation!"; }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_LOADING_REPARATIONS
        {

            get { return "Something Went Wrong While Loaing Reparations!"; }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_UPDATING_REPARATION
        {

            get { return "Something Went Wrong While Updating Reparation!";  }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_ADDING_PART
        {

            get { return "Something Went Wrong While Adding Part!"; }

        }


        public static string SOMETHING_WENT_WRONG_WHILE_REMOVING_PART
        {

            get { return "Something Went Wrong While Removing Part!"; }
